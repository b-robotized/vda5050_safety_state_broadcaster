...
If you are familiar with ROS 2, here are the quick-and-dirty build instructions.
  ...
  git clone git@github.com:vda5050_safety_state_broadcaster/vda5050_safety_state_broadcaster.git src/vda5050_safety_state_broadcaster
  vcs import src --input src/vda5050_safety_state_broadcaster/vda5050_safety_state_broadcaster.jazzy.repos
  vcs import src --input src/vda5050_safety_state_broadcaster/vda5050_safety_state_broadcaster.jazzy.upstream.repos
